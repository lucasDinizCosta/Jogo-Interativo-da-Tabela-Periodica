...
public class TabelaPeriodica implements ActionListener{
	...
	//Especificações
	private ImageIcon imagemEspec = new ImageIcon(getClass().getResource("/imagens/Especificações.PNG"));	
	
	//Coluna 1A
    private ImageIcon imagemH = new ImageIcon(getClass().getResource("/imagens/H.PNG"));
	private ImageIcon imagemLi = new ImageIcon(getClass().getResource("/imagens/Li.PNG"));
	private ImageIcon imagemNa = new ImageIcon(getClass().getResource("/imagens/Na.PNG"));
	private ImageIcon imagemK = new ImageIcon(getClass().getResource("/imagens/K.PNG"));
	private ImageIcon imagemRb = new ImageIcon(getClass().getResource("/imagens/Rb.PNG"));
	private ImageIcon imagemCs = new ImageIcon(getClass().getResource("/imagens/Cs.PNG"));
	private ImageIcon imagemFr = new ImageIcon(getClass().getResource("/imagens/Fr.PNG"));
	//Coluna2A
	private ImageIcon imagemBe = new ImageIcon(getClass().getResource("/imagens/Be.PNG"));
	private ImageIcon imagemMg = new ImageIcon(getClass().getResource("/imagens/Mg.PNG"));
	private ImageIcon imagemCa = new ImageIcon(getClass().getResource("/imagens/Ca.PNG"));
	private ImageIcon imagemSr = new ImageIcon(getClass().getResource("/imagens/Sr.PNG"));
	private ImageIcon imagemBa = new ImageIcon(getClass().getResource("/imagens/Ba.PNG"));
	private ImageIcon imagemRa = new ImageIcon(getClass().getResource("/imagens/Ra.PNG"));
	//Coluna 3B
	private ImageIcon imagemSc = new ImageIcon(getClass().getResource("/imagens/Sc.PNG"));
	private ImageIcon imagemY = new ImageIcon(getClass().getResource("/imagens/Y.PNG"));
	private ImageIcon imagemLantanideos = new ImageIcon(getClass().getResource("/imagens/57-71.PNG"));
	private ImageIcon imagemActinideos = new ImageIcon(getClass().getResource("/imagens/89-103.PNG"));
	//Coluna 4B
	private ImageIcon imagemTi = new ImageIcon(getClass().getResource("/imagens/Ti.PNG"));
	private ImageIcon imagemZr = new ImageIcon(getClass().getResource("/imagens/Zr.PNG"));
	private ImageIcon imagemHf = new ImageIcon(getClass().getResource("/imagens/Hf.PNG"));
	private ImageIcon imagemRf = new ImageIcon(getClass().getResource("/imagens/Rf.PNG"));
	//Coluna 5B
	private ImageIcon imagemV = new ImageIcon(getClass().getResource("/imagens/V.PNG"));
	private ImageIcon imagemNb = new ImageIcon(getClass().getResource("/imagens/Nb.PNG"));
	private ImageIcon imagemTa = new ImageIcon(getClass().getResource("/imagens/Ta.PNG"));
	private ImageIcon imagemDb = new ImageIcon(getClass().getResource("/imagens/Db.PNG"));
	//Coluna 6B
	private ImageIcon imagemCr = new ImageIcon(getClass().getResource("/imagens/Cr.PNG"));
	private ImageIcon imagemMo = new ImageIcon(getClass().getResource("/imagens/Mo.PNG"));
	private ImageIcon imagemW = new ImageIcon(getClass().getResource("/imagens/W.PNG"));
	private ImageIcon imagemSg = new ImageIcon(getClass().getResource("/imagens/Sg.PNG"));
	//Coluna 7B
	private ImageIcon imagemMn = new ImageIcon(getClass().getResource("/imagens/Mn.PNG"));
	private ImageIcon imagemTc = new ImageIcon(getClass().getResource("/imagens/Tc.PNG"));
	private ImageIcon imagemRe = new ImageIcon(getClass().getResource("/imagens/Re.PNG"));
	private ImageIcon imagemBh = new ImageIcon(getClass().getResource("/imagens/Bh.PNG"));
	//Coluna 8B
	//Fila 1
	private ImageIcon imagemFe = new ImageIcon(getClass().getResource("/imagens/Fe.PNG"));
	private ImageIcon imagemRu = new ImageIcon(getClass().getResource("/imagens/Ru.PNG"));
	private ImageIcon imagemOs = new ImageIcon(getClass().getResource("/imagens/Os.PNG"));
	private ImageIcon imagemHs = new ImageIcon(getClass().getResource("/imagens/Hs.PNG"));
	
	//Fila 2
	private ImageIcon imagemCo = new ImageIcon(getClass().getResource("/imagens/Co.PNG"));
	private ImageIcon imagemRh = new ImageIcon(getClass().getResource("/imagens/Rh.PNG"));
	private ImageIcon imagemIr = new ImageIcon(getClass().getResource("/imagens/Ir.PNG"));
	private ImageIcon imagemMt = new ImageIcon(getClass().getResource("/imagens/Mt.PNG"));
	
	//Fila 3
	private ImageIcon imagemNi = new ImageIcon(getClass().getResource("/imagens/Ni.PNG"));
	private ImageIcon imagemPd = new ImageIcon(getClass().getResource("/imagens/Pd.PNG"));
	private ImageIcon imagemPt = new ImageIcon(getClass().getResource("/imagens/Pt.PNG"));
	private ImageIcon imagemDs = new ImageIcon(getClass().getResource("/imagens/Ds.PNG"));
	
	//Coluna 1B
	private ImageIcon imagemCu = new ImageIcon(getClass().getResource("/imagens/Cu.PNG"));
	private ImageIcon imagemAg = new ImageIcon(getClass().getResource("/imagens/Ag.PNG"));
	private ImageIcon imagemAu = new ImageIcon(getClass().getResource("/imagens/Au.PNG"));
	private ImageIcon imagemRg = new ImageIcon(getClass().getResource("/imagens/Rg.PNG"));

	//Coluna 2B
	private ImageIcon imagemZn = new ImageIcon(getClass().getResource("/imagens/Zn.PNG"));
	private ImageIcon imagemCd = new ImageIcon(getClass().getResource("/imagens/Cd.PNG"));
	private ImageIcon imagemHg = new ImageIcon(getClass().getResource("/imagens/Hg.PNG"));
	private ImageIcon imagemCn = new ImageIcon(getClass().getResource("/imagens/Cn.PNG"));
	
	//Familia 3A
	private ImageIcon imagemB = new ImageIcon(getClass().getResource("/imagens/B.PNG"));
	private ImageIcon imagemAl = new ImageIcon(getClass().getResource("/imagens/Al.PNG"));
	private ImageIcon imagemGa = new ImageIcon(getClass().getResource("/imagens/Ga.PNG"));
	private ImageIcon imagemIn = new ImageIcon(getClass().getResource("/imagens/In.PNG"));
	private ImageIcon imagemTl = new ImageIcon(getClass().getResource("/imagens/Tl.PNG"));
	private ImageIcon imagemUut = new ImageIcon(getClass().getResource("/imagens/Uut.PNG"));
	
	//Familia 4A
	private ImageIcon imagemC = new ImageIcon(getClass().getResource("/imagens/C.PNG"));
	private ImageIcon imagemSi = new ImageIcon(getClass().getResource("/imagens/Si.PNG"));
	private ImageIcon imagemGe = new ImageIcon(getClass().getResource("/imagens/Ge.PNG"));
	private ImageIcon imagemSn = new ImageIcon(getClass().getResource("/imagens/Sn.PNG"));
	private ImageIcon imagemPb = new ImageIcon(getClass().getResource("/imagens/Pb.PNG"));
	private ImageIcon imagemFl = new ImageIcon(getClass().getResource("/imagens/Fl.PNG"));
	
	//Familia 5A
	private ImageIcon imagemN = new ImageIcon(getClass().getResource("/imagens/N.PNG"));
	private ImageIcon imagemP = new ImageIcon(getClass().getResource("/imagens/P.PNG"));
	private ImageIcon imagemAs = new ImageIcon(getClass().getResource("/imagens/As.PNG"));
	private ImageIcon imagemSb = new ImageIcon(getClass().getResource("/imagens/Sb.PNG"));
	private ImageIcon imagemBi = new ImageIcon(getClass().getResource("/imagens/Bi.PNG"));
	private ImageIcon imagemUup = new ImageIcon(getClass().getResource("/imagens/Uup.PNG"));
	
	//Familia 6A
	private ImageIcon imagemO = new ImageIcon(getClass().getResource("/imagens/O.PNG"));
	private ImageIcon imagemS = new ImageIcon(getClass().getResource("/imagens/S.PNG"));
	private ImageIcon imagemSe = new ImageIcon(getClass().getResource("/imagens/Se.PNG"));
	private ImageIcon imagemTe = new ImageIcon(getClass().getResource("/imagens/Te.PNG"));
	private ImageIcon imagemPo = new ImageIcon(getClass().getResource("/imagens/Po.PNG"));
	private ImageIcon imagemLv = new ImageIcon(getClass().getResource("/imagens/Lv.PNG"));
	
	//Familia 7A
	private ImageIcon imagemF = new ImageIcon(getClass().getResource("/imagens/F.PNG"));
	private ImageIcon imagemCl = new ImageIcon(getClass().getResource("/imagens/Cl.PNG"));
	private ImageIcon imagemBr = new ImageIcon(getClass().getResource("/imagens/Br.PNG"));
	private ImageIcon imagemI = new ImageIcon(getClass().getResource("/imagens/I.PNG"));
	private ImageIcon imagemAt = new ImageIcon(getClass().getResource("/imagens/At.PNG"));
	private ImageIcon imagemUus = new ImageIcon(getClass().getResource("/imagens/Uus.PNG"));
	
	//Familia 8A
	private ImageIcon imagemHe = new ImageIcon(getClass().getResource("/imagens/He.PNG"));
	private ImageIcon imagemNe = new ImageIcon(getClass().getResource("/imagens/Ne.PNG"));
	private ImageIcon imagemAr = new ImageIcon(getClass().getResource("/imagens/Ar.PNG"));
	private ImageIcon imagemKr= new ImageIcon(getClass().getResource("/imagens/Kr.PNG"));
	private ImageIcon imagemXe = new ImageIcon(getClass().getResource("/imagens/Xe.PNG"));
	private ImageIcon imagemRn = new ImageIcon(getClass().getResource("/imagens/Rn.PNG"));
	private ImageIcon imagemUuo = new ImageIcon(getClass().getResource("/imagens/Uuo.PNG"));
	
	//Lantanideos
	private ImageIcon imagemLa = new ImageIcon(getClass().getResource("/imagens/La.PNG"));
	private ImageIcon imagemCe = new ImageIcon(getClass().getResource("/imagens/Ce.PNG"));
	private ImageIcon imagemPr = new ImageIcon(getClass().getResource("/imagens/Pr.PNG"));
	private ImageIcon imagemNd = new ImageIcon(getClass().getResource("/imagens/Nd.PNG"));
	private ImageIcon imagemPm = new ImageIcon(getClass().getResource("/imagens/Pm.PNG"));
	private ImageIcon imagemSm = new ImageIcon(getClass().getResource("/imagens/Sm.PNG"));
	private ImageIcon imagemEu = new ImageIcon(getClass().getResource("/imagens/Eu.PNG"));
	private ImageIcon imagemGd = new ImageIcon(getClass().getResource("/imagens/Gd.PNG"));
	private ImageIcon imagemTb = new ImageIcon(getClass().getResource("/imagens/Tb.PNG"));
	private ImageIcon imagemDy = new ImageIcon(getClass().getResource("/imagens/Dy.PNG"));
	private ImageIcon imagemHo = new ImageIcon(getClass().getResource("/imagens/Ho.PNG"));
	private ImageIcon imagemEr = new ImageIcon(getClass().getResource("/imagens/Er.PNG"));
	private ImageIcon imagemTm = new ImageIcon(getClass().getResource("/imagens/Tm.PNG"));
	private ImageIcon imagemYb = new ImageIcon(getClass().getResource("/imagens/Yb.PNG"));
	private ImageIcon imagemLu = new ImageIcon(getClass().getResource("/imagens/Lu.PNG"));

	//Actinideos
	private ImageIcon imagemAc = new ImageIcon(getClass().getResource("/imagens/Ac.PNG"));
	private ImageIcon imagemTh = new ImageIcon(getClass().getResource("/imagens/Th.PNG"));
	private ImageIcon imagemPa = new ImageIcon(getClass().getResource("/imagens/Pa.PNG"));
	private ImageIcon imagemU = new ImageIcon(getClass().getResource("/imagens/U.PNG"));
	private ImageIcon imagemNp = new ImageIcon(getClass().getResource("/imagens/Np.PNG"));
	private ImageIcon imagemPu = new ImageIcon(getClass().getResource("/imagens/Pu.PNG"));
	private ImageIcon imagemAm = new ImageIcon(getClass().getResource("/imagens/Am.PNG"));
	private ImageIcon imagemCm = new ImageIcon(getClass().getResource("/imagens/Cm.PNG"));
	private ImageIcon imagemBk = new ImageIcon(getClass().getResource("/imagens/Bk.PNG"));
	private ImageIcon imagemCf = new ImageIcon(getClass().getResource("/imagens/Cf.PNG"));
	private ImageIcon imagemEs = new ImageIcon(getClass().getResource("/imagens/Es.PNG"));
	private ImageIcon imagemFm = new ImageIcon(getClass().getResource("/imagens/Fm.PNG"));
	private ImageIcon imagemMd = new ImageIcon(getClass().getResource("/imagens/Md.PNG"));
	private ImageIcon imagemNo = new ImageIcon(getClass().getResource("/imagens/No.PNG"));
	private ImageIcon imagemLr = new ImageIcon(getClass().getResource("/imagens/Lr.PNG"));
	...
	private ImageIcon imagemBarraEsq = new ImageIcon(getClass().getResource("/imagens/barraEsq.PNG"));
	private ImageIcon imagemBarraDir = new ImageIcon(getClass().getResource("/imagens/barraDir.PNG"));
	...
	private ImageIcon ImageInfo = new ImageIcon(getClass().getResource("/imagens/Informações adicionais.PNG"));
