...
public class Pergunta7 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio dois metais alcalinos da tabela periódica
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/07.jpg"));
		...
		private int porcentagem = 250;	//Começa no 150 pois a barra e decrescente
