...
public class Pergunta40 implements ActionListener{
	...
	//Pergunta: Coloque os elementos alumínio, silício e fósforo no tubo de ensaio.
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/40.jpg"));
		...
		private JLabel aluminio = new JLabel();
		private JLabel silicio = new JLabel();	//Estes campos estarão nas posições dos elementos na tabela e tem como primeira imagem o recipiente 39x39
		private JLabel fosforo = new JLabel();
		...
		private JLabel escritoAluminio = new JLabel("Alumínio");
		private JLabel escritoSilicio = new JLabel("Silício");
		private JLabel escritoFosforo = new JLabel("Fósforo");
	...
	public void transferHandler(){
		...
		//CAMPO RESPOSTAS
		aluminio.setTransferHandler(new TransferHandler("icon"));
		silicio.setTransferHandler(new TransferHandler("icon"));
		fosforo.setTransferHandler(new TransferHandler("icon"));
	}
	...
	public void setRespostas(){
		escritoSilicio.setBounds(440, 529, 70, 15);
		escritoAluminio.setBounds(554, 529, 75, 15);
		escritoFosforo.setBounds(678, 529, 70, 15);
		escritoAluminio.setFont(fonteEscritoRespostas);
		escritoSilicio.setFont(fonteEscritoRespostas);
		escritoFosforo.setFont(fonteEscritoRespostas);
		escritoAluminio.setForeground(Color.RED);
		escritoSilicio.setForeground(Color.BLACK);
		escritoFosforo.setForeground(Color.BLUE);
		silicio.setBounds(446, 477, 39, 39);
		aluminio.setBounds(565, 477, 39, 39);
		fosforo.setBounds(686, 477, 39, 39);
		...
		fundo.add(fosforo);
		fundo.add(silicio);
		fundo.add(escritoAluminio);
		fundo.add(escritoSilicio);
		fundo.add(escritoFosforo);
	}
	...
	public void exibirRespostas(){
		aluminio.setIcon(imagemAl);
		silicio.setIcon(imagemSi);
		fosforo.setIcon(imagemP);
	}
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==responder){
			...
			if(aluminio.getIcon()==imagemAl&&silicio.getIcon()==imagemSi&&fosforo.getIcon()==imagemP){	//se as imagens dos espacos forem iguais as imagens dos elementos faça o ponto virar 200, OU SEJA ACERTO
				if(pontosBonus>=0){
					exibirRespostas();
