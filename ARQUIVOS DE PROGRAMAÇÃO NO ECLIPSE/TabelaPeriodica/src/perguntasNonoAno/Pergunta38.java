...
public class Pergunta38 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento que possui 6 prótons no núcleo. 
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/38.jpg"));
