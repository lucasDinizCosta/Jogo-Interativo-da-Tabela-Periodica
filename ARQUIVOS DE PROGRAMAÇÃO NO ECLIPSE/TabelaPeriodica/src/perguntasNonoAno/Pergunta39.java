...
public class Pergunta39 implements ActionListener{
	...
	//Pergunta: Coloque os elementos cálcio e sódio no tubo de ensaio. 
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/39.jpg"));
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==responder){
			if(resposta1.getIcon()==imagemNa||resposta1.getIcon()==imagemCa){ 
				...
				if(resposta2.getIcon()==imagemNa||resposta2.getIcon()==imagemCa){
