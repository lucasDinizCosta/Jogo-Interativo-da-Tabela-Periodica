...
public class Pergunta23 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio um elemento não metal. 
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/23.jpg"));
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==responder){
			if(resposta.getIcon()==imagemB||resposta.getIcon()==imagemC||resposta.getIcon()==imagemN||resposta.getIcon()==imagemO||resposta.getIcon()==imagemF||resposta.getIcon()==imagemSi||resposta.getIcon()==imagemP||resposta.getIcon()==imagemS||resposta.getIcon()==imagemCl||resposta.getIcon()==imagemAs||resposta.getIcon()==imagemBr||resposta.getIcon()==imagemTe||resposta.getIcon()==imagemI||resposta.getIcon()==imagemAt){ 
