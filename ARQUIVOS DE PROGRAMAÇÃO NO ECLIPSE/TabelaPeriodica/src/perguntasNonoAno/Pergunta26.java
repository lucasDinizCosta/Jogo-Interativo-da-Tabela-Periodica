...
public class Pergunta26 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio os dois elementos presentes no sal de cozinha. 
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/26.jpg"));
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==responder){
			if(resposta1.getIcon()==imagemNa||resposta1.getIcon()==imagemCl){ 
				...
				if(resposta2.getIcon()==imagemNa||resposta2.getIcon()==imagemCl){
