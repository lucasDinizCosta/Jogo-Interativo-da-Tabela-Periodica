...
import InterfaceGrafica.AuxSortearPerguntaNono;

public class Pergunta3 implements ActionListener{
	
	//Pergunta: Rearranje os elementos Li, Ba, Mg e Au arrastando-os para a tabela periódica.
	...
	//Imagens dos elementos preto e branco
		
		// Coluna 1A
	private ImageIcon imagemH = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/1 H.jpg"));
	private ImageIcon imagemLi = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/3 Li.jpg"));
	private ImageIcon imagemNa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/11 Na.jpg"));
	private ImageIcon imagemK = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/19 K.jpg"));
	private ImageIcon imagemRb = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/37 Rb.jpg"));
	private ImageIcon imagemCs = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/55 Cs.jpg"));
	private ImageIcon imagemFr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/87 Fr.jpg"));
		// Coluna2A
	private ImageIcon imagemBe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/4 Be.jpg"));
	private ImageIcon imagemMg = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/12 Mg.jpg"));
	private ImageIcon imagemCa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/20 Ca.jpg"));
	private ImageIcon imagemSr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/38 Sr.jpg"));
	private ImageIcon imagemBa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/56 Ba.jpg"));
	private ImageIcon imagemRa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/88 Ra.jpg"));
		// Coluna 3B
	private ImageIcon imagemSc = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/21 Sc.jpg"));
	private ImageIcon imagemY = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/39 Y.jpg"));
	private ImageIcon imagemLigador = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/57-71 89-103.jpg"));
		// Coluna 4B
	private ImageIcon imagemTi = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/22 Ti.jpg"));
	private ImageIcon imagemZr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/40 Zr.jpg"));
	private ImageIcon imagemHf = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/72 Hf.jpg"));
	private ImageIcon imagemRf = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/104 Rf.jpg"));
		// Coluna 5B
	private ImageIcon imagemV = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/23 V.jpg"));
	private ImageIcon imagemNb = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/41 Nb.jpg"));
	private ImageIcon imagemTa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/73 Ta.jpg"));
	private ImageIcon imagemDb = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/105 Db.jpg"));
		// Coluna 6B
	private ImageIcon imagemCr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/24 Cr.jpg"));
	private ImageIcon imagemMo = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/42 Mo.jpg"));
	private ImageIcon imagemW = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/74 W.jpg"));
	private ImageIcon imagemSg = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/106 Sg.jpg"));
		// Coluna 7B
	private ImageIcon imagemMn = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/25 Mn.jpg"));
	private ImageIcon imagemTc = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/43 Tc.jpg"));
	private ImageIcon imagemRe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/75 Re.jpg"));
	private ImageIcon imagemBh = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/107 Bh.jpg"));
		// Coluna 8B
		// Fila 1
	private ImageIcon imagemFe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/26 Fe.jpg"));
	private ImageIcon imagemRu = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/44 Ru.jpg"));
	private ImageIcon imagemOs = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/76 Os.jpg"));
	private ImageIcon imagemHs = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/108 Hs.jpg"));

		// Fila 2
	private ImageIcon imagemCo = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/27 Co.jpg"));
	private ImageIcon imagemRh = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/45 Rh.jpg"));
	private ImageIcon imagemIr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/77 Ir.jpg"));
	private ImageIcon imagemMt = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/109 Mt.jpg"));

		// Fila 3
	private ImageIcon imagemNi = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/28 Ni.jpg"));
	private ImageIcon imagemPd = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/46 Pd.jpg"));
	private ImageIcon imagemPt = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/78 Pt.jpg"));
	private ImageIcon imagemDs = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/110 Ds.jpg"));

		// Coluna 1B
	private ImageIcon imagemCu = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/29 Cu.jpg"));
	private ImageIcon imagemAg = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/47 Ag.jpg"));
	private ImageIcon imagemAu = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/79 Au.jpg"));
	private ImageIcon imagemRg = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/111 Rg.jpg"));

		// Coluna 2B
	private ImageIcon imagemZn = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/30 Zn.jpg"));
	private ImageIcon imagemCd = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/48 Cd.jpg"));
	private ImageIcon imagemHg = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/80 Hg.jpg"));
	private ImageIcon imagemCn = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/112 Cn.jpg"));

		// Familia 3A
	private ImageIcon imagemB = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/5 B.jpg"));
	private ImageIcon imagemAl = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/13 Al.jpg"));
	private ImageIcon imagemGa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/31 Ga.jpg"));
	private ImageIcon imagemIn = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/49 In.jpg"));
	private ImageIcon imagemTl = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/81 Tl.jpg"));
	private ImageIcon imagemUut = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/113 Uut.jpg"));

		// Familia 4A
	private ImageIcon imagemC = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/6 C.jpg"));
	private ImageIcon imagemSi = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/14 Si.jpg"));
	private ImageIcon imagemGe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/32 Ge.jpg"));
	private ImageIcon imagemSn = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/50 Sn.jpg"));
	private ImageIcon imagemPb = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/82 Pb.jpg"));
	private ImageIcon imagemFl = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/114 Fl.jpg"));

		// Familia 5A
	private ImageIcon imagemN = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/7 N.jpg"));
	private ImageIcon imagemP = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/15 P.jpg"));
	private ImageIcon imagemAs = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/33 As.jpg"));
	private ImageIcon imagemSb = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/51 Sb.jpg"));
	private ImageIcon imagemBi = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/83 Bi.jpg"));
	private ImageIcon imagemUup = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/115 Uup.jpg"));

		// Familia 6A
	private ImageIcon imagemO = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/8 O.jpg"));
	private ImageIcon imagemS = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/16 S.jpg"));
	private ImageIcon imagemSe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/34 Se.jpg"));
	private ImageIcon imagemTe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/52 Te.jpg"));
	private ImageIcon imagemPo = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/84 Po.jpg"));
	private ImageIcon imagemLv = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/116 Lv.jpg"));

		// Familia 7A
	private ImageIcon imagemF = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/9 F.jpg"));
	private ImageIcon imagemCl = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/17 Cl.jpg"));
	private ImageIcon imagemBr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/35 Br.jpg"));
	private ImageIcon imagemI = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/53 I.jpg"));
	private ImageIcon imagemAt = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/85 At.jpg"));
	private ImageIcon imagemUus = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/117 Uus.jpg"));

		// Familia 8A
	private ImageIcon imagemHe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/2 He.jpg"));
	private ImageIcon imagemNe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/10 Ne.jpg"));
	private ImageIcon imagemAr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/18 Ar.jpg"));
	private ImageIcon imagemKr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/36 Kr.jpg"));
	private ImageIcon imagemXe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/54 Xe.jpg"));
	private ImageIcon imagemRn = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/86 Rn.jpg"));
	private ImageIcon imagemUuo = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/118 Uuo.jpg"));

		// Lantanideos
	private ImageIcon imagemLa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/57 La.jpg"));
	private ImageIcon imagemCe = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/58 Ce.jpg"));
	private ImageIcon imagemPr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/59 Pr.jpg"));
	private ImageIcon imagemNd = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/60 Nd.jpg"));
	private ImageIcon imagemPm = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/61 Pm.jpg"));
	private ImageIcon imagemSm = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/62 Sm.jpg"));
	private ImageIcon imagemEu = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/63 Eu.jpg"));
	private ImageIcon imagemGd = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/64 Gd.jpg"));
	private ImageIcon imagemTb = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/65 Tb.jpg"));
	private ImageIcon imagemDy = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/66 Dy.jpg"));
	private ImageIcon imagemHo = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/67 Ho.jpg"));
	private ImageIcon imagemEr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/68 Er.jpg"));
	private ImageIcon imagemTm = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/69 Tm.jpg"));
	private ImageIcon imagemYb = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/70 Yb.jpg"));
	private ImageIcon imagemLu = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/71 Lu.jpg"));

		// Actinideos
	private ImageIcon imagemAc = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/89 Ac.jpg"));
	private ImageIcon imagemTh = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/90 Th.jpg"));
	private ImageIcon imagemPa = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/91 Pa.jpg"));
	private ImageIcon imagemU = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/92 U.jpg"));
	private ImageIcon imagemNp = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/93 Np.jpg"));
	private ImageIcon imagemPu = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/94 Pu.jpg"));
	private ImageIcon imagemAm = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/95 Am.jpg"));
	private ImageIcon imagemCm = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/96 Cm.jpg"));
	private ImageIcon imagemBk = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/97 Bk.jpg"));
	private ImageIcon imagemCf = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/98 Cf.jpg"));
	private ImageIcon imagemEs = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/99 Es.jpg"));
	private ImageIcon imagemFm = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/100 Fm.jpg"));
	private ImageIcon imagemMd = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/101 Md.jpg"));
	private ImageIcon imagemNo = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/102 No.jpg"));
	private ImageIcon imagemLr = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosPretoBranco/103 Lr.jpg"));
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/03.jpg"));
	...
	private JProgressBar barra = new JProgressBar(0,250);	//Barra de Bônus variando de 200 a 0
	private JPanel painel = new JPanel();	//Pane que armazena a barra
	private int porcentagem = 250;	//Começa no 200 pois a barra e decrescente
	...
	*/
	...
	//Campo das respostas
	private ImageIcon imagemLiColorido = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosColoridos/3 Li.jpg"));
	private ImageIcon imagemMgColorido = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosColoridos/12 Mg.jpg"));
	private ImageIcon imagemBaColorido = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosColoridos/56 Ba.jpg"));
	private ImageIcon imagemAuColorido = new ImageIcon(getClass().getResource("/imagens/imagensPerguntasElementosColoridos/79 Au.jpg"));
	private ImageIcon imagemRecipienteMenor = new ImageIcon(getClass().getResource("/imagens/Recipiente39x39.png"));
	private ImageIcon imagemRecipienteMaior = new ImageIcon(getClass().getResource("/imagens/Recipiente.png"));
	private JLabel resposta1 = new JLabel();
	private JLabel resposta2 = new JLabel();	//Estes campos estarão nas posições dos elementos na tabela e tem como primeira imagem o recipiente 39x39
	private JLabel resposta3 = new JLabel();
	private JLabel resposta4 = new JLabel();
	private JLabel fundoElemento1 = new JLabel();
	private JLabel fundoElemento2 = new JLabel();	//Fundo de 'Recipiente' dos campos dos elementos que serão arrastados 
	private JLabel fundoElemento3 = new JLabel();
	private JLabel fundoElemento4 = new JLabel();
	...
	private MouseListener m1 = new MouseListener() {
		...
		public Pergunta3(InterfaceGrafica.Aluno aluno){
	...
	public void setImagemElementosQuimicos() {
		// Atribuindo imagens
		H.setIcon(imagemH); // Adicionando a imagem do elemento químico como ícone
		Li.setIcon(imagemLi);
		Na.setIcon(imagemNa);
		K.setIcon(imagemK);
		Rb.setIcon(imagemRb);
	...
	public void transferHandler() {
		...
		// CAMPO RESPOSTAS
		resposta1.setTransferHandler(new TransferHandler("icon"));
		resposta2.setTransferHandler(new TransferHandler("icon"));
		resposta3.setTransferHandler(new TransferHandler("icon"));
		resposta4.setTransferHandler(new TransferHandler("icon"));
	}
	...
	public void setRespostas() {
		Au.setBounds(446, 477, 39, 39);
		Mg.setBounds(566, 477, 39, 39);
		Li.setBounds(686, 477, 39, 39);
		Ba.setBounds(806, 477, 39, 39);
		resposta1.setBounds(293, 62, 39, 39);
		resposta2.setBounds(332, 101, 39, 39); // Estarão na tabela
		resposta3.setBounds(332, 218, 39, 39);
		resposta4.setBounds(683, 218, 39, 39);
		fundoElemento1.setBounds(435, 469, 61, 58);
		fundoElemento2.setBounds(555, 469, 61, 58);
		fundoElemento3.setBounds(675, 469, 61, 58);
		fundoElemento4.setBounds(795, 469, 61, 58);
		fundoElemento1.setIcon(imagemRecipienteMaior);
		fundoElemento2.setIcon(imagemRecipienteMaior);
		fundoElemento3.setIcon(imagemRecipienteMaior);
		fundoElemento4.setIcon(imagemRecipienteMaior);
		resposta1.setIcon(imagemRecipienteMenor);
		resposta2.setIcon(imagemRecipienteMenor);
		resposta3.setIcon(imagemRecipienteMenor);
		resposta4.setIcon(imagemRecipienteMenor);
		fundo.add(fundoElemento1);
		fundo.add(fundoElemento2);
		fundo.add(fundoElemento3);
		fundo.add(fundoElemento4);
		fundo.add(Li);
		fundo.add(Mg);
		fundo.add(Ba);
		fundo.add(Au);
	...
	/**
	 * STATUS DO JOGADOR Responsável por atribuir o marcador dos acertos, erros
	 * ou pergunta atual
	 */
	...
	public void exibirRespostas() {
		resposta1.setIcon(imagemLiColorido);
		resposta2.setIcon(imagemMgColorido);
		resposta3.setIcon(imagemBaColorido);
		resposta4.setIcon(imagemAuColorido);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==responder){
			...
			if(resposta1.getIcon()==imagemLi&&resposta2.getIcon()==imagemMg&&resposta3.getIcon()==imagemBa&&resposta4.getIcon()==imagemAu){	//se as imagens dos espacos forem iguais as imagens dos elementos faça o ponto virar 200, OU SEJA ACERTO
				if(pontosBonus>=0){
					exibirRespostas();
		...
		Timer t2 = new Timer(10, new ActionListener(){	
			public void actionPerformed(ActionEvent e){
				if(paraThreads==false){	//Enquanto o usuário não tiver respondido ou a próxima pergunta não for liberada a correção da tabela será válida, caso contrário a reparação é finalizada para consumir menos processamento
					if(Li.getIcon()!=imagemLi||Mg.getIcon()!=imagemMg||Ba.getIcon()!=imagemBa||Au.getIcon()!=imagemAu){
						Li.setIcon(imagemLi);
						Mg.setIcon(imagemMg);
						Ba.setIcon(imagemBa);
						Au.setIcon(imagemAu);
					}
					if(contadorParaLeitura>0){	//Faz com que o jogador não responda antes do tempo de leitura das perguntas terminar
						Li.setIcon(imagemLi);
						Mg.setIcon(imagemMg);
						Ba.setIcon(imagemBa);
						Au.setIcon(imagemAu);
		...
		Timer tempoDestraveAntesHora = new Timer(500, new ActionListener(){	//Tempo de análise de 0,5 segundos
			public void actionPerformed(ActionEvent e){
				if(paraThreads==false){	//Caso o botão responder não foi clicado a variável continuará falsa
					if(indice2 <= Pergunta3.this.aluno.getIndiceDestrave()){ 	//Se o indice2 for menor ou igual ao do aluno, significa que está aguardando um novo destrave
						try{	//Tratar excessões existentes
							if(caminho.toFile().exists()){	//Se o arquivo de texto existe com Destravador existe através da rede
								...
								if(indice2 == Pergunta3.this.aluno.getIndiceDestrave()){	//Se os destraves do arquivo estão conforme o do aluno, qualquer outro significa iniciar nova pergunta
					...
					else if(indice2 > Pergunta3.this.aluno.getIndiceDestrave()){	//Se o destrave da próxima pergunta foi feito e o botão responder não foi clicado
						t.stop();
						tempoDestraveAntesHora.stop();
						Pergunta3.this.aluno.setRegistroPontosPerguntas(0);
						Pergunta3.this.aluno.setResposta(new Boolean(false));
						if(Pergunta3.this.aluno.getSizeRegistroPontosPerguntas()<10){
						...
						else if(Pergunta3.this.aluno.getSizeRegistroPontosPerguntas()>=10){
							janela.dispose();
							AuxSortearPerguntaNono sort = new AuxSortearPerguntaNono();
							sort.proximaPergunta(Pergunta3.this.aluno);
						}
					}
				}
	...
	public class verificadorDeDestraveProximaPergunta extends Thread implements ActionListener{	//VERIFICA SE O DESTRAVE FOI FEITO E O ARQUIVO EXISTE
		...
		Timer t5 = new Timer(1000, new ActionListener(){	//Representa 1 segundo
			public void actionPerformed(ActionEvent e){
				if(indice3 <= Pergunta3.this.aluno.getIndiceDestrave()){
					try{
						if(caminho.toFile().exists()){	//Se o arquivo de texto existe
							...
							if((indice3==10)&&(Pergunta3.this.aluno.getSizePerguntaIndividual()==0)){	//Representa o destrave da ultima pergunta
								t5.stop();
							}
							if(indice3==Pergunta3.this.aluno.getIndiceDestrave()){	//Se o número de destraves do arquivo for equivalente ao do aluno será necessário um novo destrave
				...
				else if(indice3 > Pergunta3.this.aluno.getIndiceDestrave()){
		...
		public void JanelaTransicao(){
			//JANELA
			if(Pergunta3.this.aluno.getSizePerguntaIndividual()>0){	//Enquanto houver perguntas a serem respondidas
				...
				proxima.setEnabled(false);	//false
				j2.add(proxima);
				j2.add(imagem);
				j2.add(mensagem);
