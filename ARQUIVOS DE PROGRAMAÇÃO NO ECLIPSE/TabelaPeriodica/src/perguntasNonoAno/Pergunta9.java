...
public class Pergunta9 implements ActionListener{
	
	//Pergunta: Coloque no tubo de ensaio dois metais da tabela periódica.
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/09.jpg"));
	...
	public Pergunta9(InterfaceGrafica.Aluno aluno){
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==responder){
			if(resposta1.getIcon() == imagemTi|| resposta1.getIcon() == imagemZr|| resposta1.getIcon() == imagemHf|| resposta1.getIcon() == imagemRf|| resposta1.getIcon() == imagemV	|| resposta1.getIcon() == imagemNb|| resposta1.getIcon() == imagemTa|| resposta1.getIcon() == imagemDb|| resposta1.getIcon() == imagemCr|| resposta1.getIcon() == imagemMo|| resposta1.getIcon() == imagemW|| resposta1.getIcon() == imagemSg	|| resposta1.getIcon() == imagemMn|| resposta1.getIcon() == imagemTc|| resposta1.getIcon() == imagemRe|| resposta1.getIcon() == imagemBh|| resposta1.getIcon() == imagemFe|| resposta1.getIcon() == imagemRu|| resposta1.getIcon() == imagemOs|| resposta1.getIcon() == imagemHs|| resposta1.getIcon() == imagemCo|| resposta1.getIcon() == imagemRh|| resposta1.getIcon() == imagemIr
			|| resposta1.getIcon() == imagemMt|| resposta1.getIcon() == imagemNi|| resposta1.getIcon() == imagemPd|| resposta1.getIcon() == imagemPt|| resposta1.getIcon() == imagemDs|| resposta1.getIcon() == imagemCu|| resposta1.getIcon() == imagemAg|| resposta1.getIcon() == imagemAu|| resposta1.getIcon() == imagemRg|| resposta1.getIcon() == imagemZn|| resposta1.getIcon() == imagemCd|| resposta1.getIcon() == imagemHg|| resposta1.getIcon() == imagemCn|| resposta1.getIcon() == imagemSc|| resposta1.getIcon() == imagemY|| resposta1.getIcon() == imagemBe|| resposta1.getIcon() == imagemMg|| resposta1.getIcon() == imagemCa|| resposta1.getIcon() == imagemSr
			|| resposta1.getIcon() == imagemBa|| resposta1.getIcon() == imagemRa|| resposta1.getIcon() == imagemLi|| resposta1.getIcon() == imagemNa|| resposta1.getIcon() == imagemK	|| resposta1.getIcon() == imagemRb|| resposta1.getIcon() == imagemCs|| resposta1.getIcon() == imagemFr|| resposta1.getIcon() == imagemSn|| resposta1.getIcon() == imagemPb|| resposta1.getIcon() == imagemBi|| resposta1.getIcon() == imagemLa|| resposta1.getIcon() == imagemCe|| resposta1.getIcon() == imagemPr|| resposta1.getIcon() == imagemNd|| resposta1.getIcon() == imagemPm|| resposta1.getIcon() == imagemSm|| resposta1.getIcon() == imagemEu|| resposta1.getIcon() == imagemGd|| resposta1.getIcon() == imagemTb|| resposta1.getIcon() == imagemDy|| resposta1.getIcon() == imagemHo|| resposta1.getIcon() == imagemEr|| resposta1.getIcon() == imagemTm
			|| resposta1.getIcon() == imagemYb|| resposta1.getIcon() == imagemLu|| resposta1.getIcon() == imagemAc|| resposta1.getIcon() == imagemTh|| resposta1.getIcon() == imagemPa|| resposta1.getIcon() == imagemU|| resposta1.getIcon() == imagemNp|| resposta1.getIcon() == imagemPu|| resposta1.getIcon() == imagemAm|| resposta1.getIcon() == imagemCm|| resposta1.getIcon() == imagemBk|| resposta1.getIcon() == imagemCf|| resposta1.getIcon() == imagemEs|| resposta1.getIcon() == imagemFm|| resposta1.getIcon() == imagemMd|| resposta1.getIcon() == imagemNo||resposta1.getIcon() == imagemLr|| resposta1.getIcon() == imagemAl|| resposta1.getIcon() == imagemGa|| resposta1.getIcon() == imagemIn|| resposta1.getIcon() == imagemTl||resposta1.getIcon() == imagemGe|| resposta1.getIcon() == imagemSb|| resposta1.getIcon() == imagemPo
			){
				...
				if(resposta2.getIcon() == imagemTi|| resposta2.getIcon() == imagemZr|| resposta2.getIcon() == imagemHf|| resposta2.getIcon() == imagemRf|| resposta2.getIcon() == imagemV	|| resposta2.getIcon() == imagemNb|| resposta2.getIcon() == imagemTa|| resposta2.getIcon() == imagemDb|| resposta2.getIcon() == imagemCr|| resposta2.getIcon() == imagemMo|| resposta2.getIcon() == imagemW|| resposta2.getIcon() == imagemSg	|| resposta2.getIcon() == imagemMn|| resposta2.getIcon() == imagemTc|| resposta2.getIcon() == imagemRe|| resposta2.getIcon() == imagemBh|| resposta2.getIcon() == imagemFe|| resposta2.getIcon() == imagemRu|| resposta2.getIcon() == imagemOs|| resposta2.getIcon() == imagemHs|| resposta2.getIcon() == imagemCo|| resposta2.getIcon() == imagemRh|| resposta2.getIcon() == imagemIr
				|| resposta2.getIcon() == imagemMt|| resposta2.getIcon() == imagemNi|| resposta2.getIcon() == imagemPd|| resposta2.getIcon() == imagemPt|| resposta2.getIcon() == imagemDs|| resposta2.getIcon() == imagemCu|| resposta2.getIcon() == imagemAg|| resposta2.getIcon() == imagemAu|| resposta2.getIcon() == imagemRg|| resposta2.getIcon() == imagemZn|| resposta2.getIcon() == imagemCd|| resposta2.getIcon() == imagemHg|| resposta2.getIcon() == imagemCn|| resposta2.getIcon() == imagemSc|| resposta2.getIcon() == imagemY|| resposta2.getIcon() == imagemBe|| resposta2.getIcon() == imagemMg|| resposta2.getIcon() == imagemCa|| resposta2.getIcon() == imagemSr
				|| resposta2.getIcon() == imagemBa|| resposta2.getIcon() == imagemRa|| resposta2.getIcon() == imagemLi|| resposta2.getIcon() == imagemNa|| resposta2.getIcon() == imagemK	|| resposta2.getIcon() == imagemRb|| resposta2.getIcon() == imagemCs|| resposta2.getIcon() == imagemFr|| resposta2.getIcon() == imagemSn|| resposta2.getIcon() == imagemPb|| resposta2.getIcon() == imagemBi|| resposta2.getIcon() == imagemLa|| resposta2.getIcon() == imagemCe|| resposta2.getIcon() == imagemPr|| resposta2.getIcon() == imagemNd|| resposta2.getIcon() == imagemPm|| resposta2.getIcon() == imagemSm|| resposta2.getIcon() == imagemEu|| resposta2.getIcon() == imagemGd|| resposta2.getIcon() == imagemTb|| resposta2.getIcon() == imagemDy|| resposta2.getIcon() == imagemHo|| resposta2.getIcon() == imagemEr|| resposta2.getIcon() == imagemTm
				|| resposta2.getIcon() == imagemYb|| resposta2.getIcon() == imagemLu|| resposta2.getIcon() == imagemAc|| resposta2.getIcon() == imagemTh|| resposta2.getIcon() == imagemPa|| resposta2.getIcon() == imagemU|| resposta2.getIcon() == imagemNp|| resposta2.getIcon() == imagemPu|| resposta2.getIcon() == imagemAm|| resposta2.getIcon() == imagemCm|| resposta2.getIcon() == imagemBk|| resposta2.getIcon() == imagemCf|| resposta2.getIcon() == imagemEs|| resposta2.getIcon() == imagemFm|| resposta2.getIcon() == imagemMd|| resposta2.getIcon() == imagemNo||resposta2.getIcon() == imagemLr|| resposta2.getIcon() == imagemAl|| resposta2.getIcon() == imagemGa|| resposta2.getIcon() == imagemIn|| resposta2.getIcon() == imagemTl||resposta2.getIcon() == imagemGe|| resposta2.getIcon() == imagemSb|| resposta2.getIcon() == imagemPo
				){
		...
		Timer tempoDestraveAntesHora = new Timer(500, new ActionListener(){	//Tempo de análise de 0,5 segundos
			public void actionPerformed(ActionEvent e){
				if(paraThreads==false){	//Caso o botão responder não foi clicado a variável continuará falsa
					if(indice2 <= Pergunta9.this.aluno.getIndiceDestrave()){ 	//Se o indice2 for menor ou igual ao do aluno, significa que está aguardando um novo destrave
						try{	//Tratar excessões existentes
							if(caminho.toFile().exists()){	//Se o arquivo de texto existe com Destravador existe através da rede
								...
								if(indice2 == Pergunta9.this.aluno.getIndiceDestrave()){	//Se os destraves do arquivo estão conforme o do aluno, qualquer outro significa iniciar nova pergunta
					...
					else if(indice2 > Pergunta9.this.aluno.getIndiceDestrave()){	//Se o destrave da próxima pergunta foi feito e o botão responder não foi clicado
						t.stop();
						tempoDestraveAntesHora.stop();
						Pergunta9.this.aluno.setRegistroPontosPerguntas(0);
						Pergunta9.this.aluno.setResposta(new Boolean(false));
						if(Pergunta9.this.aluno.getSizeRegistroPontosPerguntas()<10){
						...
						else if(Pergunta9.this.aluno.getSizeRegistroPontosPerguntas()>=10){
							janela.dispose();
							AuxSortearPerguntaNono sort = new AuxSortearPerguntaNono();
							sort.proximaPergunta(Pergunta9.this.aluno);
						}
					}
				}
	...
	public class verificadorDeDestraveProximaPergunta extends Thread implements ActionListener{	//VERIFICA SE O DESTRAVE FOI FEITO E O ARQUIVO EXISTE
		...
		Timer t5 = new Timer(1000, new ActionListener(){	//Representa 1 segundo
			public void actionPerformed(ActionEvent e){
				if(indice3 <= Pergunta9.this.aluno.getIndiceDestrave()){
					try{	//esse erro tratado seria caso a URL seja inválida
						if(caminho.toFile().exists()){	//Se o arquivo de texto existe
							...
							if((indice3==10)&&(Pergunta9.this.aluno.getSizePerguntaIndividual()==0)){	//Representa o destrave da ultima pergunta
								t5.stop();
							}
							if(indice3==Pergunta9.this.aluno.getIndiceDestrave()){	//Se o número de destraves do arquivo for equivalente ao do aluno será necessário um novo destrave
				...
				else if(indice3 > Pergunta9.this.aluno.getIndiceDestrave()){
		...
		public void JanelaTransicao(){
			//JANELA
			if(Pergunta9.this.aluno.getSizePerguntaIndividual()>0){	//Enquanto houver perguntas a serem respondidas
