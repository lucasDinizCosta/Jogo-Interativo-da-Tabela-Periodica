...
public class Pergunta31 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento que ocorre com maior frequência na crosta terrestre. 
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/31.jpg"));
