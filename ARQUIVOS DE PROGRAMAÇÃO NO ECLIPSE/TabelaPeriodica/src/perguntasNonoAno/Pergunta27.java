...
public class Pergunta27 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio os elementos magnésio, manganês e mercúrio. 
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/27.jpg"));
		...
		private JLabel mercurio = new JLabel();
		private JLabel magnesio = new JLabel();	//Estes campos estarão nas posições dos elementos na tabela e tem como primeira imagem o recipiente 39x39
		private JLabel manganes = new JLabel();
		...
		private JLabel escritoMercurio = new JLabel("Mercúrio");
		private JLabel escritoManganes = new JLabel("Manganês");
		private JLabel escritoMagnesio = new JLabel("Magnésio");
	...
	public void transferHandler(){
		...
		//CAMPO RESPOSTAS
		mercurio.setTransferHandler(new TransferHandler("icon"));
		magnesio.setTransferHandler(new TransferHandler("icon"));
		manganes.setTransferHandler(new TransferHandler("icon"));
	}
	...
	public void setRespostas(){
		escritoMercurio.setBounds(434, 529, 70, 15);
		escritoManganes.setBounds(550, 529, 75, 15);
		escritoMagnesio.setBounds(672, 529, 70, 15);
		escritoMercurio.setFont(fonteEscritoRespostas);
		escritoManganes.setFont(fonteEscritoRespostas);
		escritoMagnesio.setFont(fonteEscritoRespostas);
		escritoMercurio.setForeground(Color.RED);
		escritoManganes.setForeground(Color.BLACK);
		escritoMagnesio.setForeground(Color.BLUE);
		mercurio.setBounds(446, 477, 39, 39);
		manganes.setBounds(565, 477, 39, 39);
		magnesio.setBounds(686, 477, 39, 39);
		...
		fundo.add(manganes);
		fundo.add(magnesio);
		fundo.add(escritoMercurio);
		fundo.add(escritoManganes);
		fundo.add(escritoMagnesio);
	}
	...
	public void exibirRespostas(){
		...
		mercurio.setIcon(imagemHg);
		magnesio.setIcon(imagemMg);
		manganes.setIcon(imagemMn);
	}
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==responder){
			...
			if(mercurio.getIcon()==imagemHg&&magnesio.getIcon()==imagemMg&&manganes.getIcon()==imagemMn){	//se as imagens dos espacos forem iguais as imagens dos elementos faça o ponto virar 200, OU SEJA ACERTO
				if(pontosBonus>=0){
					exibirRespostas();
