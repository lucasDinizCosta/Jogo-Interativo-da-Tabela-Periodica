...
public class Pergunta14 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio dois elementos que são líquidos à temperatura ambiente.
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/14.jpg"));
	...
	public void actionPerformed(ActionEvent e){
		...
		if(e.getSource()==responder){
			if(resposta1.getIcon()==imagemHg||resposta1.getIcon()==imagemBr){ 
				...
				if(resposta2.getIcon()==imagemHg||resposta2.getIcon()==imagemBr){
