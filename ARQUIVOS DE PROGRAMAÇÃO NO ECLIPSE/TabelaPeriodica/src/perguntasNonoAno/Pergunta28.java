...
public class Pergunta28 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o gás nobre que possui a menor massa atômica.  
	...
	//ELEMENTOS QUÍMICOS
		...
		private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/NonoAno/28.jpg"));
