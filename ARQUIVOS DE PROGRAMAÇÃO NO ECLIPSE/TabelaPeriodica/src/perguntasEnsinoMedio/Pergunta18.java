...
public class Pergunta18 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento não metálico da família 6ª com o maior raio atômico.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/18.jpg"));
	...
	private JPanel painel = new JPanel();	//Panel que armazena a barra
