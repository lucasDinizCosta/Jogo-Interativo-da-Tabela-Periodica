...
public class Pergunta16 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento de maior eletronegatividade do 5º período. 
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/16.jpg"));
