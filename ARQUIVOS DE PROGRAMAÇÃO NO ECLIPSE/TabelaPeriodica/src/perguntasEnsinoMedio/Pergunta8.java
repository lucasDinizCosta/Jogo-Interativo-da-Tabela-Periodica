...
public class Pergunta8 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento de menor número atômico.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/08.jpg"));
