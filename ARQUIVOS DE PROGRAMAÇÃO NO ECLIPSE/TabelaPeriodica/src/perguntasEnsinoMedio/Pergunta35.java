...
public class Pergunta35 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento químico que possui três camadas eletrônicas e está localizado na família 2. 
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/35.jpg"));
