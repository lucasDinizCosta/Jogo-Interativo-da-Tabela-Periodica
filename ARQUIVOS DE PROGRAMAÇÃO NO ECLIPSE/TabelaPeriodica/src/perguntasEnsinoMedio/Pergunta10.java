...
public class Pergunta10 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento que possui distribuição eletrônica 1s2 2s2 2p6.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/10.jpg"));
