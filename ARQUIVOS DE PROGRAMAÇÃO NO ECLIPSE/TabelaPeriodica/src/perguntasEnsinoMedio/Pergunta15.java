...
public class Pergunta15 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento de maior eletronegatividade da família 15.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/15.jpg"));
