...
public class Pergunta12 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento com maior energia de ionização da família 17.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/12.jpg"));
