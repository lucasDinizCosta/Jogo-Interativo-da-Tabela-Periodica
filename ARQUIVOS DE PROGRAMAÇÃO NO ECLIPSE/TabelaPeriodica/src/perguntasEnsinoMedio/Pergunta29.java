...
public class Pergunta29 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o não metal de maior energia de ionização da tabela.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/29.jpg"));
