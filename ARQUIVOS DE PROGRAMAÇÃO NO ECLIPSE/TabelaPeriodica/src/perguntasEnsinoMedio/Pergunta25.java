...
public class Pergunta25 implements ActionListener{
	...
	//Pergunta:	Coloque no tubo de ensaio o metal alcalino terroso de maior energia de ionização.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/25.jpg"));
