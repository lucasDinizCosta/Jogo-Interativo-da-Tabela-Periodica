...
public class Pergunta34 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o único não metal líquido à temperatura ambiente. 
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/34.jpg"));
