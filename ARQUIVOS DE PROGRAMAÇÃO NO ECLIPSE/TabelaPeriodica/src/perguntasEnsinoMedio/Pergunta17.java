...
public class Pergunta17 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento de maior raio atômico do 2º período. 
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/17.jpg"));
