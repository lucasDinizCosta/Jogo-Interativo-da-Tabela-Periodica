...
public class Pergunta9 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio dois gases nobres.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/09.jpg"));
