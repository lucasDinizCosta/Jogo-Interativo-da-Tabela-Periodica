...
public class Pergunta33 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o único metal líquido à temperatura ambiente.
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/33.jpg"));
