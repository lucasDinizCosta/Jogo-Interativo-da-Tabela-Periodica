...
public class Pergunta5 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o metal que possui a maior densidade da tabela periódica. 
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/05.jpg"));
