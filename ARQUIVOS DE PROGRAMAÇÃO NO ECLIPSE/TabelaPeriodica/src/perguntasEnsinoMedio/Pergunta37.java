...
public class Pergunta37 implements ActionListener{
	...
	//Pergunta: Coloque no tubo de ensaio o elemento químico que tem 3 elétrons no estado neutro. 
	...
	private ImageIcon imagemPergunta = new ImageIcon(getClass().getResource("/imagens/imagensEnunciados/EnsinoMedio/37.jpg"));
